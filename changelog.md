...
|------|--------|----------------|-------|
| 2026-05-20 | ingest: agentic-coding-principles | engineering/agentic-coding-principles.md, index.md, lean-engineering.md, spec-driven-development.md, log.md, changelog.md | New card: Agentic Coding — 6 principles + 28 practices for production-quality AI collaboration; "meteor over fireball" framework; backlinked from lean-engineering and SDD |
