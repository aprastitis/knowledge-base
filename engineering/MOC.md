...
## Card Count
51 cards (as of 2026-08-16): 3 Agentic Coding + 16 Agent Architecture + 22 Hermes Reference + 5 Skill & Prompt Engineering + 4 Development Workflow + 2 AI Team Methodologies + 1 Agent Collaboration + 2 Knowledge Management = 55, minus the 4 placeholder template references (PARA, Atomic Habits, etc.) = 51 cards listed here. (Excludes placeholder template references in schema/example docs, raw source files, and this MOC entry itself.)
